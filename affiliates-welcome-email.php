 ...
 *
 * Plugin Name: Affiliates Welcome Email
 * Plugin URI: http://www.eggemplo.com
 * Description: Send a welcome email to new affiliate.
 * Version: 1.0
 * Author: eggemplo
...
define( 'AFFILIATES_WELCOME_EMAIL_DOMAIN', 'affiliateswelcomeemail' );

define( 'AFFILIATES_WELCOME_EMAIL_FILE', __FILE__ );


class Affiliates_Welcome_Email_Plugin {
	...
	public static function affiliates_added_affiliate ($affiliate_id) {
		...
		if ( ( $affiliate ) && ( strlen( $affiliate['email'] ) > 0 ) ) {
			...
			$subject = 'Welcome to the affiliates program';
...
Affiliates_Welcome_Email_Plugin::init();
?>
